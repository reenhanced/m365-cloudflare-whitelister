(function () {
  ...
  function buildInstructions(cidrs, opts) {
    ...
    lines.push("");
    lines.push("======================================================================");
    lines.push("  Generated by Reenhanced — reenhanced.com/power-automate-cloudflare/");
  ...
  function buildTemplate() {
    ...
    return [
      ...
      '<p>Built by <a href="https://reenhanced.com" target="_blank" rel="noopener">Reenhanced</a> &mdash; the world\'s best solution for WordPress + Microsoft.<br>Azure Service Tags are updated weekly. <a href="https://reenhanced.com/power-automate-cloudflare/" target="_blank" rel="noopener">Run this tool again</a> periodically to keep your rules current.</p>',
      '</div>',
